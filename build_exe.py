...
try:
    ...
    print()
    print("📂 ESTRUCTURA DE ARCHIVOS DE DATOS:")
    print("   Para usar archivos CSV de lecturas del radar, crea esta estructura")
    print("   junto al ejecutable:")
    print()
    print("   SoftwareRadar.exe")
    print("   └── output/")
    print("       └── Lecturas RADAR/")
    print("           └── tu_archivo.csv")
    print()
    print("   💡 La aplicación creará estas carpetas automáticamente si no existen.")
    print("   💡 Si no hay archivos CSV, puedes usar el modo DEMO en el panel de mapa.")
    print()
